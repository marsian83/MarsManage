...
(function () {
  ...
  function Wa(h, m, F) {
    "millisecond" === F
      ...
      : "year" === F && h.setFullYear(h.getFullYear() + 1 * m);
    return h;
  }
  function ca(h, m) {
    var F = !1;
  ...
  function J(h, m, F, v, Y) {
    v = v || [];
    Y = r(Y) ? (gb ? { passive: !1, capture: !1 } : !1) : Y;
    v.push([h, m, F, Y]);
    return h.addEventListener
      ? (h.addEventListener(m, F, Y), F)
      : h.attachEvent
      ? ((v = function (m) {
          m = m || window.event;
          m.preventDefault =
  ...
  function xa(h, m, r) {
    ...
    m.getAttribute("state") !== r &&
      (m.setAttribute("state", r),
      ...
      m.setAttribute("title", h._cultureInfo[r + "Text"]),
      (m.innerHTML =
        "<img src='" +
        kb[r].image +
        "' alt='" +
        h._cultureInfo[r + "Text"] +
        "' />"),
      V(m.childNodes[0], { height: "95%", pointerEvents: "none" }));
  }
  function La() {
  ...
  function Sa(h, m, r, v, Y) {
    if (null === h || "undefined" === typeof h)
      return "undefined" === typeof r ? m : r;
    h =
      parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? m / 100 : 1);
    "undefined" !== typeof v &&
      ((h = Math.min(v, h)), "undefined" !== typeof Y && (h = Math.max(Y, h)));
  ...
  function W(h, m, F, v, Y) {
    ...
    h = {};
    this.theme && r(this.parent) && r(m) && r(v)
      ...
      : this.parent &&
        ...
        (null === v
          ...
          : 0 < this.parent.themeOptions[m].length &&
            ((v = Math.min(this.parent.themeOptions[m].length - 1, v)),
            (h = this.parent.themeOptions[m][v])));
    this.themeOptions = h;
  ...
  function za(h, m) {
    za.base.constructor.call(this, "Title", "title", m, null, h);
    this.chart = h;
    this.canvas = h.canvas;
    this.ctx = this.chart.ctx;
    ...
    if (r(this.options.margin) && h.options.subtitles)
      for (var F = h.options.subtitles, v = 0; v < F.length; v++)
        if (
          ((r(F[v].horizontalAlign) && "center" === this.horizontalAlign) ||
            F[v].horizontalAlign === this.horizontalAlign) &&
          ((r(F[v].verticalAlign) && "top" === this.verticalAlign) ||
            F[v].verticalAlign === this.verticalAlign) &&
          !F[v].dockInsidePlotArea === !this.dockInsidePlotArea
        ) {
          this.margin = 0;
          break;
        }
  ...
  (function () {
    ...
    U.pos = ["cm", "cs", "um"];
    U._fTWm = function (h) {
      if ("undefined" === typeof U.pro.sCH && !cb)
        try {
          ...
          r =
            "cm" === U.pos[m] || "um" === U.pos[m]
              ? 0
              : h.width -
                Y[U.fSDec("ld`rtsdUdyu")](U.fSDec("B`ow`rKR!Ush`m")).width;
          v = "um" === U.pos[m] ? 0 : h.height - 11;
          Y[U.fSDec("ghmmUdyu")](U.fSDec("B`ow`rKR!Ush`m"), r, v);
          "cs" === U.pos[m] &&
            (h[U.fSDec("^bsdehuMhoj")].style.right = U.fSDec("`tun"));
        } catch (w) {}
    };
  })();
  var gb = (function () {
        ...
        return (Q = I.replace(h, function (l) {
          switch (l) {
            ...
            case "K":
              return U
                ? "UTC"
                : (String(A).match(w) || [""]).pop().replace(E, "");
            case "z":
        ...
        if (((m = A[N]), "." === m && 0 > I)) I = N;
          ...
          if ("%" === m) E *= 100;
            ...
            ("E" !== m[0] && "e" !== m[0]) ||
              ...
              (U = !0);
          0 > I
            ? (Q.push(m), "#" === m || "0" === m ? O++ : "," === m && K++)
            : (P.push(m), ("#" !== m && "0" !== m) || J++);
        }
      U &&
        ((m = Math.floor(h)),
        (A = -Math.floor(Math.log(h) / Math.LN10 + 1)),
        (V = 0 === h ? 0 : 0 === m ? -(O + A) : String(m).length - O),
        (E /= Math.pow(10, V)));
      0 > I && (I = N);
      E = (h * E).toFixed(J);
      m = E.split(".");
        ...
        if (((m = Q.pop()), "#" === m || "0" === m))
          if ((I++, I === O)) {
            var ba = E,
              E = [];
            if ("0" === m)
              for (m = O - J - (ba ? ba.length : 0); 0 < m; )
                ba.unshift("0"), m--;
            for (; 0 < ba.length; )
              (r = ba.pop() + r),
                U++,
                0 === U % A && N === K && 0 < ba.length && (r = w + r);
          } else
            0 < E.length
              ? ((r = E.pop() + r), J++, U++)
              : "0" === m && ((r = "0" + r), J++, U++),
              0 === U % A && N === K && 0 < E.length && (r = w + r);
        else
          ("E" !== m[0] && "e" !== m[0]) ||
          "0" !== m[m.length - 1] ||
          !/[eE][+-]*[0]+/.test(m)
            ? "," === m
              ? (N++, (A = U), (U = 0), 0 < E.length && (r = w + r))
              : (r =
                  1 < m.length &&
                  (('"' === m[0] && '"' === m[m.length - 1]) ||
                    ("'" === m[0] && "'" === m[m.length - 1]))
                    ? m.slice(1, m.length - 1) + r
                    : m + r)
            : ((m =
                0 > V
                  ? m.replace("+", "").replace("-", "")
                  : m.replace("-", "")),
              (r += m.replace(/[0]+/, function (a) {
    ...
    Oa = function (h) {
      ...
      h.offsetX || 0 === h.offsetX
        ? ((m = h.offsetX), (r = h.offsetY))
        : h.layerX || 0 == h.layerX
        ? ((m = h.layerX), (r = h.layerY))
    ...
    da = function (h, m, r, v, w, A, E, I, O, Q, U, P, J) {
      ...
      0 < E &&
        ...
        (h.strokeStyle = I),
        h.moveTo(m, r),
        h.rect(m - J, r - J, v - m + 2 * J, w - r + 2 * J),
        h.stroke());
      h.restore();
      !0 === O &&
        (h.save(),
        ...
        h.lineTo(v, r),
        h.closePath(),
        (E = h.createLinearGradient((v + m) / 2, r + K, (v + m) / 2, r)),
        E.addColorStop(0, A),
      ...
      !0 === Q &&
        ...
        h.lineTo(v, w),
        h.closePath(),
        (E = h.createLinearGradient((v + m) / 2, w - K, (v + m) / 2, w)),
        E.addColorStop(0, A),
        E.addColorStop(1, "rgba(255, 255, 255, .4)"),
        (h.fillStyle = E),
        h.fill(),
      ...
      !0 === U &&
        ...
        h.lineTo(m, w),
        h.closePath(),
        (E = h.createLinearGradient(m + K, (w + r) / 2, m, (w + r) / 2)),
        E.addColorStop(0, A),
      ...
      !0 === P &&
        ...
        h.lineTo(v - K, w - K),
        h.lineTo(v, w),
        (E = h.createLinearGradient(v - K, (w + r) / 2, v, (w + r) / 2)),
        E.addColorStop(0, A),
        E.addColorStop(1, "rgba(255, 255, 255, 0.1)"),
        (h.fillStyle = E),
        E.addColorStop(0, A),
  ...
  W.prototype.setOptions = function (h, m) {
    if (ra[this._defaultsKey]) {
      ...
      for (v in r)
        "publicProperties" !== v &&
          r.hasOwnProperty(v) &&
          (this[v] = h && v in h ? h[v] : m && v in m ? m[v] : r[v]);
  ...
  W.prototype.updateOption = function (h) {
    ...
    var m = ra[this._defaultsKey],
      ...
      I = this._index;
    this.theme && r(this.parent) && r(A) && r(I)
      ? (v = r(this.predefinedThemes[this.theme])
          ? this.predefinedThemes.light1
          : this.predefinedThemes[this.theme])
      : this.parent &&
        this.parent.themeOptions &&
        ...
        (null === I
          ? (v = this.parent.themeOptions[A])
          : 0 < this.parent.themeOptions[A].length &&
            ((v = Math.min(this.parent.themeOptions[A].length - 1, I)),
            (v = this.parent.themeOptions[A][v])));
    this.themeOptions = v;
    h in m &&
      (w = h in this.options ? this.options[h] : v && h in v ? v[h] : m[h]);
  ...
  W.prototype.addEventListener = function (h, m, r) {
    h &&
      ...
      this._eventListeners[h].push({ context: r || this, eventHandler: m }));
  };
  ...
  W.prototype.dispatchEvent = function (h, m, r) {
    if (h && this._eventListeners[h]) {
      m = m || {};
      for (var v = this._eventListeners[h], w = 0; w < v.length; w++)
        v[w].eventHandler.call(v[w].context, m);
    }
  ...
  ka.prototype.render = function (h) {
    if (0 !== this.fontSize) {
      ...
      for (r = 0; r < this._wrappedText.lines.length; r++) {
        A = this._wrappedText.lines[r];
        if ("right" === this.horizontalAlign || "right" === this.textAlign)
          v = this.width - A.width - this.rightPadding;
  ...
  ka.prototype._getLineWithWidth = function (h, m, r) {
    ...
    r > m &&
      1 < E.length &&
      ((E = E.substr(0, E.length - 1)), (r = this.ctx.measureText(E).width));
    m = !0;
  ...
  ka.prototype._wrapText = function () {
    ...
    if (0 === this.frontSize) w = v = 0;
      ...
      for (; 0 < h.length; ) {
        var A = this.maxHeight - (this.topPadding + this.bottomPadding),
    ...
    this._wrappedText = { lines: m, width: w, height: v };
  ...
  za.prototype.setLayout = function () {
    if (this.text) {
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? (null === this.maxWidth &&
            (this.maxWidth =
              m.width - 4 - E * ("center" === this.horizontalAlign ? 2 : 1)),
      ...
      "top" === this.verticalAlign || "bottom" === this.verticalAlign
        ? ("top" === this.verticalAlign
            ...
            : "bottom" === this.verticalAlign &&
              ((w = m.y2 - 2 - Q.height), (J = "bottom")),
          "left" === this.horizontalAlign
            ? (v = m.x1 + 2)
            : "center" === this.horizontalAlign
            ? (v = m.x1 + m.width / 2 - Q.width / 2)
            : "right" === this.horizontalAlign && (v = m.x2 - 2 - Q.width - E),
        ...
        : "center" === this.verticalAlign &&
          ("left" === this.horizontalAlign
            ? ((v = m.x1 + 2),
              (w = m.y2 - 2 - (this.maxWidth / 2 - Q.width / 2)),
              (A = -90),
              (J = "left"),
              (this.width = Q.height),
              (this.height = Q.width))
            ...
            ? ((v = m.x2 - 2),
              (w = m.y1 + 2 + (this.maxWidth / 2 - Q.width / 2)),
              (A = 90),
              (J = "right"),
              (this.width = Q.height),
              (this.height = Q.width))
            : "center" === this.horizontalAlign &&
              ((w = h.y1 + (h.height / 2 - Q.height / 2)),
              (v = h.x1 + (h.width / 2 - Q.width / 2)),
              (J = "center"),
              (this.width = Q.width),
              (this.height = Q.height)),
          (K = "center"));
      ...
      this.bounds = { x1: v, y1: w, x2: v + this.width, y2: w + this.height };
  ...
  w = Pa.Chart = (function () {
    ...
    function w(a, d) {
      for (var c = [], b, e = 0; e < a.length; e++)
        if (0 == e) c.push(a[0]);
          ...
          b = (a[l].y - a[f].y) / b;
          c[c.length] =
            (a[s].x > a[f].x && 0 < C) || (a[s].x < a[f].x && 0 > C)
              ? { x: a[s].x + C / 3, y: a[s].y + b / 3 }
              : { x: a[s].x, y: a[s].y + b / 9 };
          s = e;
          f = 0 === s ? 0 : s - 1;
          l = s === a.length - 1 ? s : s + 1;
    ...
    function X(a, d, c, b) {
      X.base.constructor.call(this, "DataSeries", "data", d, c, a);
      this.chart = a;
      this.canvas = a.canvas;
      ...
      for (d = 0; d < this.plotInfo.plotTypes.length; d++)
        for (
          ...
          "line" === s.type
            ? (C = this.renderLine(s))
            : "stepLine" === s.type
            ? (C = this.renderStepLine(s))
            : "spline" === s.type
            ? (C = this.renderSpline(s))
            : "column" === s.type
            ? (C = this.renderColumn(s))
            : "bar" === s.type
            ? (C = this.renderBar(s))
            : "area" === s.type
            ? (C = this.renderArea(s))
            : "stepArea" === s.type
            ? (C = this.renderStepArea(s))
            : "splineArea" === s.type
            ? (C = this.renderSplineArea(s))
            : "stackedColumn" === s.type
            ? (C = this.renderStackedColumn(s))
            : "stackedColumn100" === s.type
            ? (C = this.renderStackedColumn100(s))
            : "stackedBar" === s.type
            ? (C = this.renderStackedBar(s))
            : "stackedBar100" === s.type
            ? (C = this.renderStackedBar100(s))
            : "stackedArea" === s.type
            ? (C = this.renderStackedArea(s))
            : "stackedArea100" === s.type
            ? (C = this.renderStackedArea100(s))
            : "bubble" === s.type
            ? (C = C = this.renderBubble(s))
            : "scatter" === s.type
            ? (C = this.renderScatter(s))
            : "pie" === s.type
            ? this.renderPie(s)
            : "doughnut" === s.type
            ? this.renderPie(s)
            : "funnel" === s.type
            ? (C = this.renderFunnel(s))
            : "pyramid" === s.type
            ? (C = this.renderFunnel(s))
            : "candlestick" === s.type
            ? (C = this.renderCandlestick(s))
            : "ohlc" === s.type
            ? (C = this.renderCandlestick(s))
            : "rangeColumn" === s.type
            ? (C = this.renderRangeColumn(s))
            : "error" === s.type
            ? (C = this.renderError(s))
            : "rangeBar" === s.type
            ? (C = this.renderRangeBar(s))
            : "rangeArea" === s.type
            ? (C = this.renderRangeArea(s))
            : "rangeSplineArea" === s.type
            ? (C = this.renderRangeSplineArea(s))
            : "waterfall" === s.type
            ? (C = this.renderWaterfall(s))
            : "boxAndWhisker" === s.type && (C = this.renderBoxAndWhisker(s));
          for (var k = 0; k < s.dataSeriesIndexes.length; k++)
            this._dataInRenderedOrder.push(this.data[s.dataSeriesIndexes[k]]);
          this.animatedRender &&
            ((s.targetCanvasCtx.miterLimit = e), C && c.push(C));
        }
          ...
          n._animator.animate(
            ...
            function (a) {
              ...
              n.ctx.drawImage(
                ...
                0,
                0,
                Math.floor(n.width * la),
                Math.floor(n.height * la),
                0,
                0,
                n.width,
                n.height
          ...
          if ("normal" === s.axisPlacement || "xySwapped" === s.axisPlacement)
            var q = a.axisX.sessionVariables.newViewportMinimum
              ...
              g = a.axisX.sessionVariables.newViewportMaximum
                ...
                : Infinity;
          if (
            (s.dataPoints[C].x && s.dataPoints[C].x.getTime) ||
            "dateTime" === s.xValueType
          )
            f = !0;
          for (C = 0; C < s.dataPoints.length; C++) {
            "undefined" === typeof s.dataPoints[C].x &&
              (s.dataPoints[C].x = C + (a.axisX.logarithmic ? 1 : 0));
            s.dataPoints[C].x.getTime
              ? ((f = !0), (b = s.dataPoints[C].x.getTime()))
              : (b = s.dataPoints[C].x);
            e = s.dataPoints[C].y;
            b < c.min && (c.min = b);
            b > c.max && (c.max = b);
            ...
            if (0 < C) {
              if (a.axisX.logarithmic) {
                ...
                (t = b - s.dataPoints[C - 1].x),
                  0 > t && (t *= -1),
                  c.minDiff > t && 0 !== t && (c.minDiff = t);
              null !== e &&
                null !== s.dataPoints[C - 1].y &&
                (a.axisY.logarithmic
                  ? ((t = e / s.dataPoints[C - 1].y),
                    1 > t && (t = 1 / t),
            ...
            if (b < q && !k) null !== e && (p = b);
              ...
              s.dataPoints[C].label &&
                (a.axisX.labels[b] = s.dataPoints[C].label);
      ...
      if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
        for (
          ...
          for (q = 0; q < p.dataPoints.length; q++) {
            ...
            if (b < L && !g) null !== p.dataPoints[q].y && (h = b);
            else {
              if (!g && ((g = !0), 0 < q)) {
                q -= 2;
                continue;
        ...
        for (
          ...
          for (n = 0; n < k.dataPoints.length; n++) {
            ...
            k.dataPoints[n].x.getTime
              ? ((s = !0), (b = k.dataPoints[n].x.getTime()))
              : (b = k.dataPoints[n].x);
      ...
      if (
        ...
        for (
          ...
          if (
            ...
            f = !0;
          for (C = 0; C < s.dataPoints.length; C++)
            "undefined" !== typeof s.dataPoints[C].isCumulativeSum &&
            !0 === s.dataPoints[C].isCumulativeSum
              ? ((s.dataPointEOs[C].cumulativeSumYStartValue = 0),
                (s.dataPointEOs[C].cumulativeSum =
                  0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum),
                (s.dataPoints[C].y =
                  0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum))
              : "undefined" !== typeof s.dataPoints[C].isIntermediateSum &&
                !0 === s.dataPoints[C].isIntermediateSum
              ? ((s.dataPointEOs[C].cumulativeSumYStartValue = p),
                (s.dataPointEOs[C].cumulativeSum =
                  0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum),
                (s.dataPoints[C].y = 0 === C ? 0 : b),
                (p = 0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum),
                (b = 0))
              : ((e =
                  "number" !== typeof s.dataPoints[C].y
                    ? 0
                    : s.dataPoints[C].y),
                (s.dataPointEOs[C].cumulativeSumYStartValue =
                  0 === C ? 0 : s.dataPointEOs[C - 1].cumulativeSum),
                (s.dataPointEOs[C].cumulativeSum =
                  0 === C ? e : s.dataPointEOs[C - 1].cumulativeSum + e),
                (b += e));
          for (C = 0; C < s.dataPoints.length; C++)
            if (
              ("undefined" === typeof s.dataPoints[C].x &&
              ...
              b < c.min && (c.min = b),
              b > c.max && (c.max = b),
              s.dataPointEOs[C].cumulativeSum < d.min &&
                (d.min = s.dataPointEOs[C].cumulativeSum),
              s.dataPointEOs[C].cumulativeSum > d.max &&
                (d.max = s.dataPointEOs[C].cumulativeSum),
              0 < C &&
                (a.axisX.logarithmic
                  ? ((p = b / s.dataPoints[C - 1].x),
                    1 > p && (p = 1 / p),
                ...
                null !== e &&
                  ...
                  (a.axisY.logarithmic
                    ? ((e =
                        s.dataPointEOs[C].cumulativeSum /
                        s.dataPointEOs[C - 1].cumulativeSum),
                      1 > e && (e = 1 / e),
              ...
              b > c.viewPortMax && (c.viewPortMax = b);
              0 < C &&
                (s.dataPointEOs[C - 1].cumulativeSum < d.viewPortMin &&
                  (d.viewPortMin = s.dataPointEOs[C - 1].cumulativeSum),
                s.dataPointEOs[C - 1].cumulativeSum > d.viewPortMax &&
                  (d.viewPortMax = s.dataPointEOs[C - 1].cumulativeSum));
              s.dataPointEOs[C].cumulativeSum < d.viewPortMin &&
                (d.viewPortMin = s.dataPointEOs[C].cumulativeSum);
              s.dataPointEOs[C].cumulativeSum > d.viewPortMax &&
                (d.viewPortMax = s.dataPointEOs[C].cumulativeSum);
            }
          s.axisX.valueType = s.xValueType = f ? "dateTime" : "number";
        }
    };
                  ...
                  if (
                    ...
                    if (
                      ...
                      for (var v = 0; v < g.length; v++)
                        (q = Math.floor((g[v] - n) / m)),
                          g[v] < d[q].min && (d[q].min = g[v]),
                          g[v] > d[q].max && (d[q].max = g[v]);
                    else
                      r(g) ||
                        ((q = Math.floor((g - n) / m)),
                        g < d[q].min && (d[q].min = g),
      ...
      m.capturedEventParam &&
        ...
        b.hasOwnProperty(c) &&
          ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture
            ? (a.target !== b.chart.overlaidCanvas && v) ||
      ...
      for (l = 0; l < k.length; l++) {
        ...
        if (isFinite(p.dataInfo.minDiff))
          if (
            ...
            C.push(p), n.push({ val1: q, val2: g }), (s = !0);
          else if (!e) {
            s = !1;
            break;
          }
    ...
    m.prototype.renderIndexLabels = function (a) {
      ...
      for (a = 0; a < this._indexLabels.length; a++) {
        var n = this._indexLabels[a],
          ...
          q,
          g,
          l = ma("indexLabelFontColor", n.dataPoint, n.dataSeries),
        ...
        var L = ma("indexLabelLineDashType", n.dataPoint, n.dataSeries),
          ...
          m = r(n.dataPoint.indexLabelLineThickness)
            ? r(n.dataSeries.options.indexLabelLineThickness)
              ? 0
        ...
        if (
          ...
          x = this.getPercentAndTotal(n.dataSeries, n.dataPoint);
        ...
        if (null !== D && "" !== D) {
          ...
          if ("normal" === this.plotInfo.axisPlacement) {
            ...
            "inside" !== x
              ? ((e = c.y1),
                ...
                0 < w
                  ? ((g =
                      n.point.y + ("horizontal" === B ? t / 2 : 0) - k - s - b),
                    g < e &&
                      ((g =
                        "auto" === x
                          ? Math.max(n.point.y, e) + t / 2 + s
                          : e + t / 2 + s),
                      (E = g + k > n.point.y)))
                  : ((g = n.point.y + t / 2 + s + b),
                    g > f - k &&
                      ((g =
                        "auto" === x
                          ? Math.min(n.point.y, f) + t / 2 - k - s
                          : f + t / 2 - k),
                      (E = g < n.point.y))))
              : ((e = Math.max(n.bounds.y1, c.y1)),
                (f = Math.min(n.bounds.y2, c.y2 - k + t / 2)),
                (b =
                  0 <= p.indexOf("range") || "error" === p
                    ? 0 < w
                      ? Math.max(n.bounds.y1, c.y1) + t / 2 + s
                      : Math.min(n.bounds.y2, c.y2) + t / 2 - k + s
                ...
                0 < w
                  ? ((g = Math.max(n.point.y, b)),
                    g < e &&
                      ("bubble" === p || "scatter" === p) &&
                      (g = Math.max(n.point.y - k - s, c.y1 + s)))
                  : ((g = Math.min(n.point.y, b)),
                    g > f - k - s &&
                      ("bubble" === p || "scatter" === p) &&
                      (g = Math.min(n.point.y + s, c.y2 - k - s))),
                (g = Math.min(g, f)));
          } else
            0 <= p.indexOf("line") ||
            0 <= p.indexOf("area") ||
              ...
              "inside" !== x
                ? ((e = c.x1),
                  ...
                  0 > w
                    ? ((q =
                        n.point.x -
                        ("horizontal" === B ? C : C - t / 2) -
                        l -
                        b),
                      q < e &&
                        ((q =
                          "auto" === x ? Math.max(n.point.x, e) + l : e + l),
                        (E = q + C > n.point.x)))
                    : ((q =
                        n.point.x + ("horizontal" === B ? 0 : t / 2) + l + b),
                      q > f - C - l - b &&
                        ((q =
                          "auto" === x
                ...
                : ((e = Math.max(n.bounds.x1, c.x1)),
                  ...
                  (b =
                    0 <= p.indexOf("range") || "error" === p
                      ? 0 > w
                        ? Math.max(n.bounds.x1, c.x1) + t / 2 + l
                        : Math.min(n.bounds.x2, c.x2) -
                          C / 2 -
                          l +
                          ("horizontal" === B ? 0 : t / 2)
          ...
          m &&
            ...
            d.setLineDash && d.setLineDash(I(L, m)),
            d.beginPath(),
            ...
            0 <= p.indexOf("bar") || ("error" === p && n.axisSwapped)
              ? d.lineTo(
                  q +
                    (0 < n.direction ? -l : C + l) +
                    ("vertical" === B ? -t / 2 : 0),
                  g + ("vertical" === B ? -k / 2 : k / 2 - t / 2) - s
                )
              : 0 <= p.indexOf("column") || ("error" === p && !n.axisSwapped)
              ? d.lineTo(
                  q + C / 2 - ("horizontal" === B ? 0 : t / 2),
                  g +
                    ("vertical" === B
                      ? (g - k < n.point.y ? 0 : -k) + s
                      : (g - t / 2 < n.point.y ? k : 0) - t / 2)
                )
              : d.lineTo(
                  q + C / 2 - ("horizontal" === B ? 0 : t / 2),
                  g +
      ...
      for (a = 0; a < this._indexLabels.length; a++)
        (n = this._indexLabels[a]),
          (h = ma("indexLabelBackgroundColor", n.dataPoint, n.dataSeries)),
          (n.dataSeries.indexLabelBackgroundColor = r(h)
            ? v
              ? "transparent"
              : null
            : h);
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length) {
            for (var B = !1, u = 0; u < n.length; u++)
              if (
                ((m = n[u].x.getTime ? n[u].x.getTime() : n[u].x),
                !(
                ...
                if ("number" !== typeof n[u].y)
                  ...
                  r || B
                    ...
                    : (c.lineTo(m, x),
                      ...
                      0 == u % 500 &&
                        ...
                        c.beginPath(),
                        c.moveTo(m, x),
                        v && (b.stroke(), b.beginPath(), b.moveTo(m, x))));
                  l = { x: m, y: x };
                  u < n.length - 1 &&
                    (h !== (n[u].lineColor || t) ||
                  ...
                  if (0 < n[u].markerSize || 0 < k.markerSize) {
                    var z = k.getMarkerProperties(u, m, x, c);
                    f.push(z);
                    D = O(D);
                    v &&
                      f.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var f = [], l, s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length) {
            for (var B = !1, u = 0; u < n.length; u++)
              if (
                ((m = n[u].getTime ? n[u].x.getTime() : n[u].x),
                !(
                  m < a.axisX.dataInfo.viewPortMin ||
                  (m > a.axisX.dataInfo.viewPortMax &&
                    (!k.connectNullData || !B))
                  ...
                  u < n.length - 1 &&
                    ...
                    c.setLineDash &&
                      (n[u].lineDashType
                        ...
                        : ((p = k.lineDashType), c.setLineDash(g))));
                  if (0 < n[u].markerSize || 0 < k.markerSize)
                    (D = k.getMarkerProperties(u, m, x, c)),
                      f.push(D),
                      (z = O(z)),
                      v &&
                        f.push({
        ...
        for (var l = [], s = 0; s < a.dataSeriesIndexes.length; s++) {
          ...
          if (0 < n.length)
            for (m = !1, r = 0; r < n.length; r++)
              if (
                ((u = n[r].getTime ? n[r].x.getTime() : n[r].x),
                !(
                ...
                if ("number" !== typeof n[r].y)
                  ...
                  r < n.length - 1 &&
                    (h !== (n[r].lineColor || t) ||
                      p !== (n[r].lineDashType || k.lineDashType)) &&
                    ((h = n[r].lineColor || t),
        ...
        for (n = 0; n < a.dataSeriesIndexes.length; n++) {
          ...
          if (0 < t.length)
            for (
              ...
              if (
                (t[f].getTime ? (C = t[f].x.getTime()) : (C = t[f].x),
                !(
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (C[b] = u[k].y + (C[b] ? C[b] : 0)),
                    (D = a.axisY.convertValueToPixel(C[b])),
                ...
                da(
                  c,
                  x,
                  a.axisY.reversed ? D : p,
                  B,
                  a.axisY.reversed ? p : D,
                  b,
                  0,
                  null,
                  m && (a.axisY.reversed ? 0 > u[k].y : 0 <= u[k].y),
                  (a.axisY.reversed ? 0 <= u[k].y : 0 > u[k].y) && m,
                  !1,
                  !1,
                  r.fillOpacity
                );
    ...
    m.prototype.renderStackedColumn100 = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
          ...
          if (0 < u.length)
            for (
              var m = 5 < g && r.bevelEnabled ? !0 : !1, k = 0;
              k < u.length;
              k++
            )
              if (
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                if (
                  ...
                  (C[b] = u[k].y + (C[b] ? C[b] : 0)),
                    (n = l[b] ? l[b] : q),
                    (l[b] = D = a.axisY.convertValueToPixel(C[b]));
                else if (
          ...
          if (0 < u.length) {
            ...
            for (k = 0; k < u.length; k++)
              if (
                ...
                da(
                  c,
                  a.axisY.reversed ? n : x,
                  B,
                  a.axisY.reversed ? x : n,
                  D,
                  b,
                  0,
                  null,
    ...
    m.prototype.renderArea = function (a) {
      ...
      function b() {
        D &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          v && (l.lineTo(r, B), l.lineTo(D.x, B), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(r, u),
          l.beginPath(),
          l.moveTo(r, u),
        ...
        for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
          ...
          if (0 < t.length) {
            ...
            for (var fa = !0; h < t.length; h++)
              if (
                ((m = t[h].x.getTime ? t[h].x.getTime() : t[h].x),
                !(
                  m < a.axisX.dataInfo.viewPortMin ||
                  (m > a.axisX.dataInfo.viewPortMax &&
                    (!g.connectNullData || !fa))
                ))
              )
                if ("number" !== typeof t[h].y)
                  g.connectNullData || fa || d || b(), (fa = !0);
                else {
                  ...
                  0 !== t[h].markerSize &&
                    ...
                    ((m = g.getMarkerProperties(h, r, u, f)),
                    C.push(m),
                    (aa = O(aa)),
                    v &&
                      C.push({
    ...
    m.prototype.renderSplineArea = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        b.clip();
        v && (e.beginPath(), e.rect(s.x1, s.y1, s.width, s.height), e.clip());
            ...
            for (t = !1; q < p.length; q++)
              if (
                ...
                if ("number" !== typeof p[q].y)
                    ...
                    (n.connectNullData
                      ? b.setLineDash &&
                        ...
                        (n.options.nullDataLineDashType ||
                          !p[q - 1].lineDashType) &&
                        ((y[y.length - 1].newLineDashArray = E),
                        (z = n.nullDataLineDashType))
                      : (d(), (y = []))),
                    (t = !0);
                else {
                  ...
                  q < p.length - 1 &&
                    (D !== (p[q].lineColor || B) ||
                      z !== (p[q].lineDashType || n.lineDashType)) &&
                    ((D = p[q].lineColor || B),
                    (y[y.length - 1].newStrokeStyle = D),
                    b.setLineDash &&
                      (p[q].lineDashType
                        ? ((z = p[q].lineDashType),
                          (y[y.length - 1].newLineDashArray = I(
                            z,
                            n.lineThickness
                          )))
                        : ((z = n.lineDashType),
    ...
    m.prototype.renderStepArea = function (a) {
      ...
      function b() {
        D &&
          ...
          f.fill(),
          (f.globalAlpha = 1),
          v && (l.lineTo(m, B), l.lineTo(D.x, B), l.closePath(), l.fill()),
          f.beginPath(),
          f.moveTo(m, u),
          l.beginPath(),
          l.moveTo(m, u),
            ...
            for (; r < t.length; r++)
              if (
                ...
                "number" !== typeof t[r].y
                  ...
                  : ((m = a.axisX.convertValueToPixel(y)),
                    ...
                    d || c
                      ? (!d && g.connectNullData
                          ? (f.setLineDash &&
                            ...
                            f.lineTo(m, aa),
                            f.lineTo(m, u),
                            v && (l.lineTo(m, aa), l.lineTo(m, u)))
                          : (f.beginPath(),
                            f.moveTo(m, u),
                            v && (l.beginPath(), l.moveTo(m, u)),
                            (D = { x: m, y: u })),
                        (c = d = !1))
                      : (f.lineTo(m, aa),
                        v && l.lineTo(m, aa),
                    ...
                    r < t.length - 1 &&
                      (E !== (t[r].lineColor || w) ||
                        T !== (t[r].lineDashType || g.lineDashType)) &&
                      (b(),
                      (E = t[r].lineColor || w),
                      (f.strokeStyle = E),
                      f.setLineDash &&
                        (t[r].lineDashType
                          ? ((T = t[r].lineDashType),
                            f.setLineDash(I(T, g.lineThickness)))
                          : ((T = g.lineDashType), f.setLineDash(fa)))),
                    (y = g.dataPointIds[r]),
                    ...
                    0 !== t[r].markerSize &&
                      ...
                      ((aa = g.getMarkerProperties(r, m, u, f)),
                      h.push(aa),
                      (y = O(y)),
                      v &&
                        h.push({
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var e = [], B = 0; B < a.dataSeriesIndexes.length; B++) {
          ...
          for (q = 0; q < w.length; q++)
            (D = w[q].x.getTime ? w[q].x.getTime() : w[q].x),
              ...
              if (
                !(
                  ...
                  (f > a.axisX.dataInfo.viewPortMax &&
                    (!z.connectNullData || !aa))
                )
              )
                if ("number" !== typeof ia.y)
                  z.connectNullData || aa || y || d(), (aa = !0);
                else {
                  ...
                  q < w.length - 1 &&
                    (T !== (w[q].lineColor || E) ||
                      x !== (w[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, t),
                    k.push({ x: g, y: r - oa }),
                    ...
                    b.setLineDash &&
                      (w[q].lineDashType
                        ...
                        : ((x = z.lineDashType), b.setLineDash(fa))));
            ...
            for (var aa = !0, q = 0; q < n.length; q++) {
              ...
              if (
                ...
                if ("number" !== typeof ia.y)
                  ...
                  q < w.length - 1 &&
                    (T !== (w[q].lineColor || E) ||
                      u !== (w[q].lineDashType || z.lineDashType)) &&
                    (d(),
                    b.beginPath(),
                    b.moveTo(g, t),
                    k.push({ x: g, y: y - na }),
                    ...
                    b.setLineDash &&
                      (w[q].lineDashType
                        ...
                        : ((u = z.lineDashType), b.setLineDash(A))));
                  if (0 <= z.dataPointIndexes[f]) {
                  ...
                  0 <= z.dataPointIndexes[f] &&
                    0 !== ia.markerSize &&
                    (0 < ia.markerSize || 0 < z.markerSize) &&
                    ((na = z.getMarkerProperties(q, g, t, b)),
                    s.push(na),
                    (f = O(G)),
                    v &&
                      s.push({
          ...
          if (0 < y.length)
            for (
              ...
              if (
                ...
                "candlestick" === u.type
                  ? (c.moveTo(h - w, n),
                    c.lineTo(h - w, Math.min(k, q)),
                    c.stroke(),
                    c.moveTo(h - w, Math.max(k, q)),
                    c.lineTo(h - w, p),
                    c.stroke(),
                    da(
                      c,
                    ...
                    v &&
                      ...
                      (b.strokeStyle = e),
                      b.moveTo(h - w, n),
                      b.lineTo(h - w, Math.min(k, q)),
                      b.stroke(),
                      b.moveTo(h - w, Math.max(k, q)),
                      b.lineTo(h - w, p),
                      b.stroke(),
                      da(
                        b,
                ...
                (y[s].indexLabel ||
                  ...
                  this._indexLabels.push({
                    ...
                    dataPoint: y[s],
                    dataSeries: u,
                    point: { x: B + (D - B) / 2, y: a.axisY.reversed ? p : n },
                    direction: 1,
                    bounds: {
                      x1: B,
                      y1: Math.min(n, p),
    ...
    m.prototype.renderBoxAndWhisker = function (a) {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (
          var m = !1, m = !!a.axisY.reversed, L = 0;
          L < a.dataSeriesIndexes.length;
          L++
        ) {
          ...
          if (0 < x.length)
            for (
              var B = 5 < t && y.bevelEnabled ? !0 : !1, l = 0;
              l < x.length;
              l++
            )
              if (
                ...
                var D = (s - t / 2) << 0,
                  ...
                  w = Math.round(Math.max(1, 0.15 * t)),
                  E = 0 === w % 2 ? 0 : 0.5,
                  T = x[l].whiskerColor
                    ? x[l].whiskerColor
                    : x[l].color
                  ...
                  S =
                    "number" === typeof x[l].whiskerThickness
                      ...
                      ? y.whiskerThickness
                      : w,
                  A = x[l].whiskerDashType
                    ? x[l].whiskerDashType
                    : y.whiskerDashType,
                  aa = r(x[l].whiskerLength)
                ...
                0 < J &&
                  (c.beginPath(),
                  (c.globalAlpha = 1),
                  c.setLineDash && c.setLineDash(I(Q, J)),
                  (c.strokeStyle = K),
                  (c.lineWidth = J),
                  c.moveTo(D, q - M),
                  c.lineTo(z, q - M),
                ...
                0 < S &&
                  (c.beginPath(),
                  c.setLineDash && c.setLineDash(I(A, S)),
                  (c.strokeStyle = T),
                  (c.lineWidth = S),
                  c.moveTo((s - aa / 2) << 0, p - ia),
                  c.lineTo((s + aa / 2) << 0, p - ia),
                  c.stroke(),
                  c.moveTo((s - aa / 2) << 0, h + ia),
                  c.lineTo((s + aa / 2) << 0, h + ia),
                  c.stroke());
                c.restore();
                v &&
                  ((e = O(R)),
                  ...
                  0 < na &&
                    (b.moveTo(s - E - G, k),
                    b.lineTo(s - E - G, Math.max(h, p)),
                    b.stroke(),
                    b.moveTo(s - E - G, Math.min(h, p)),
                    b.lineTo(s - E - G, n),
                    b.stroke()),
                  da(
                    b,
                  ...
                  0 < S &&
                    (b.beginPath(),
                    (b.lineWidth = S),
                    b.moveTo(s + aa / 2, p - ia),
                    b.lineTo(s - aa / 2, p - ia),
                    b.stroke(),
                    b.moveTo(s + aa / 2, h + ia),
                    b.lineTo(s - aa / 2, h + ia),
                    b.stroke()));
                (x[l].indexLabel ||
                  y.indexLabel ||
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var y = 0; y < a.dataSeriesIndexes.length; y++) {
          var x = a.dataSeriesIndexes[y],
            ...
            z = r(B._linkedSeries)
              ? !1
              : B._linkedSeries.type.match(/(bar|column)/gi) &&
                B._linkedSeries.visible
              ? !0
              : !1,
            w = 0;
          if (z)
            for (e = B._linkedSeries.id, u = 0; u < e; u++)
              !this.data[u].type.match(/(bar|column)/gi) ||
                !this.data[u].visible ||
                (this.data[u].type.match(/(stacked)/gi) && w) ||
                (this.data[u].type.match(/(range)/gi) && (f = !0), w++);
          e = this.options.dataPointMinWidth
            ? this.dataPointMinWidth
            : this.options.dataPointWidth
            ? this.dataPointWidth
          ...
          s = this.options.dataPointMaxWidth
            ...
            ? Math.min(
                0.15 * this.height,
                0.9 * (this.plotArea.height / (z ? L : 1))
              ) << 0
            : 0.3 * this.width;
          f &&
            (s = this.options.dataPointMaxWidth
            ...
            for (var E = B._colorSet, s = 0; s < D.length; s++) {
              var e = (B.lineColor = B.options.color ? B.options.color : E[0]),
                T = {
                  color: D[s].whiskerColor
                    ...
                    ? B.whiskerColor
                    : e,
                  thickness: r(D[s].whiskerThickness)
                    ? B.whiskerThickness
                    : D[s].whiskerThickness,
                  dashType: D[s].whiskerDashType
                    ? D[s].whiskerDashType
                    : B.whiskerDashType,
                  length: r(D[s].whiskerLength)
                    ? r(B.options.whiskerLength)
                      ? u
                      : B.options.whiskerLength
                    : D[s].whiskerLength,
              ...
              var S = {
                color: D[s].stemColor
                  ...
                  ? B.stemColor
                  : e,
                thickness: D[s].stemThickness
                  ? D[s].stemThickness
                  : B.stemThickness,
                dashType: D[s].stemDashType
                  ? D[s].stemDashType
                  : B.stemDashType,
              };
              S.thickness =
              ...
              if (
                ...
                !r(D[s].y) &&
                D[s].y.length &&
                "number" === typeof D[s].y[0] &&
                "number" === typeof D[s].y[1]
              ) {
                ...
                b
                  ? ((q = a.axisX.reversed
                      ? (k + ((z ? L : 1) * u) / 2 - (z ? w - 1 : 0) * u) << 0
                      : (k - ((z ? L : 1) * u) / 2 + (z ? w - 1 : 0) * u) << 0),
                    (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                  : ((n = a.axisX.reversed
                      ? (h + ((z ? L : 1) * u) / 2 - (z ? w - 1 : 0) * u) << 0
                      : (h - ((z ? L : 1) * u) / 2 + (z ? w - 1 : 0) * u) << 0),
            ...
            for (f = 0; f < t.length; f++)
              if (
                ...
                da(
                  c,
                  l,
                  a.axisX.reversed ? L : h,
                  s,
                  a.axisX.reversed ? h : L,
                  b,
                  0,
                  null,
                  m,
            ...
            for (var T = !0; g < p.length; g++)
              if (
                ...
                if (
                  ...
                  q || T
                    ? (n.connectNullData && !q
                        ? (b.setLineDash &&
                            ...
                            ((h[h.length - 1].newLineDashArray = A),
                            (z = n.nullDataLineDashType),
                            b.setLineDash(E)),
                          b.lineTo(t, r),
                          v && e.lineTo(t, r),
                  ...
                  g < p.length - 1 &&
                    (w !== (p[g].lineColor || B) ||
                      z !== (p[g].lineDashType || n.lineDashType)) &&
                    (d(),
                    (w = p[g].lineColor || B),
                    (h[h.length - 1].newStrokeStyle = w),
                    (b.strokeStyle = w),
                    b.setLineDash &&
                      (p[g].lineDashType
                        ? ((z = p[g].lineDashType),
            ...
            for (g = !1; p < n.length; p++)
              if (
                ...
                if (
                  ...
                  p < n.length - 1 &&
                    (x !== (n[p].lineColor || y) ||
                      B !== (n[p].lineDashType || k.lineDashType)) &&
                    ((x = n[p].lineColor || y),
                    (r[r.length - 1].newStrokeStyle = x),
                    b.setLineDash &&
                      (n[p].lineDashType
                        ? ((B = n[p].lineDashType),
                          (r[r.length - 1].newLineDashArray = I(
                            B,
                            k.lineThickness
                          )))
                        : ((B = k.lineDashType),
                  ...
                  0 < p &&
                    ...
                    (k.connectNullData
                      ? b.setLineDash &&
                        ...
                        (k.options.nullDataLineDashType ||
                          !n[p - 1].lineDashType) &&
                        ((r[r.length - 1].newLineDashArray = z),
        ...
        for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
          ...
          if (0 < m.length)
            for (
              ...
              if (
                (m[l].getTime ? (n = m[l].x.getTime()) : (n = m[l].x),
                "number" !== typeof m[l].y)
              ) {
                if (0 < l && !B && r.connectNullData)
                  var E =
                    r.options.nullDataLineDashType || !m[l - 1].lineDashType
                ...
                da(
                  c,
                  a.axisX.reversed ? A : s,
                  a.axisY.reversed ? k : h,
                  a.axisX.reversed ? s : A,
                ...
                var S,
                  T = s;
                S =
                  ("undefined" !== typeof m[l].isIntermediateSum &&
                    !0 === m[l].isIntermediateSum) ||
                  ("undefined" !== typeof m[l].isCumulativeSum &&
                    !0 === m[l].isCumulativeSum)
                    ? 0 < m[l].y
                      ? h
                      : k
                    : 0 < m[l].y
                ...
                0 < l &&
                  w &&
                  (!B || r.connectNullData) &&
                  (B && c.setLineDash && c.setLineDash(I(E, u)),
                  c.beginPath(),
                  c.moveTo(w, z - y),
                  c.lineTo(T, S - y),
                  0 < u && c.stroke(),
                ...
                (m[l].indexLabel ||
                  r.indexLabel ||
                  m[l].indexLabelFormatter ||
                  r.indexLabelFormatter) &&
                  this._indexLabels.push({
                    chartType: "waterfall",
                    dataPoint: m[l],
                    dataSeries: r,
                    point: { x: s + (A - s) / 2, y: 0 <= m[l].y ? h : k },
    ...
    m.prototype.renderPie = function (a) {
      ...
      function f(a, c, d) {
        ...
        if (0 <= a && a < n.length) {
          ...
          k =
            "right" === p.hemisphere
              ? x.x + Math.sqrt(Math.pow(v, 2) - Math.pow(c - x.y, 2))
              : x.x - Math.sqrt(Math.pow(v, 2) - Math.pow(c - x.y, 2));
          ...
          l &&
            ...
            (c =
              "right" === p.hemisphere
                ? x.x + Math.sqrt(Math.pow(v, 2) - Math.pow(d - x.y, 2))
                : x.x - Math.sqrt(Math.pow(v, 2) - Math.pow(d - x.y, 2))),
      ...
      function l() {
        ...
        for (
          ...
          if ("inside" !== k.indexLabelPlacement) {
            ...
            for (var s, r, a = 0; a < n.length; a++) {
              ...
              if (null !== u) {
                ...
                var B = 0,
                  B = b(s, r) - t;
                if (0 > B) {
                  for (var D = (r = 0), F = 0; F < n.length; F++)
                    F !== a &&
                  ...
                  "right" === h.hemisphere
                    ? ((F = f(a, r)),
                      (D = -1 * (B - F)),
                      (I = f(u, D)),
                      +I.toFixed(y) < +D.toFixed(y) &&
                        +F.toFixed(y) <= +r.toFixed(y) &&
                        f(a, -(D - I)))
                    : ((F = f(u, r)),
                      (D = -1 * (B - F)),
                      (I = f(a, D)),
            ...
            for (a = 0; a < n.length; a++)
              (h = g[a]),
                (v = "pie" === k.type ? 0.7 * z : 0.8 * z),
                (u = x.x + v * Math.cos(h.midAngle)),
                (r = x.y + v * Math.sin(h.midAngle)),
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        for (var D = 0; D < n.length; D++)
          (B += Math.abs(n[D].y)),
            !a &&
              "undefined" !== typeof n[D].indexLabel &&
              null !== n[D].indexLabel &&
              0 < n[D].indexLabel.toString().length &&
              (a = !0),
            !a &&
              "undefined" !== typeof n[D].label &&
              null !== n[D].label &&
              0 < n[D].label.toString().length &&
              (a = !0);
        if (0 !== B) {
          a =
            a ||
    ...
    m.prototype.renderFunnel = function (a) {
        ...
        if (u && y) {
          ...
          for (var z = 0, D = y.length - 1; z < y.length || 0 <= D; z++, D--) {
            ...
            b = b.indexLabelFormatter
              ? b.indexLabelFormatter(w)
              : b.indexLabel
              ? L.replaceKeywordsWithValue(b.indexLabel, b, u, z)
              : u.indexLabelFormatter
              ? u.indexLabelFormatter(w)
              : u.indexLabel
              ? L.replaceKeywordsWithValue(u.indexLabel, b, u, z)
              : b.label
              ? b.label
              : "";
            0 >= n && (n = 0);
        ...
        if (e)
          for (l = H.length - 1; 0 <= l; l--)
            (a = R[l]),
              ...
              u.reversed
                ? (H[l].textBlock.y + H[l].height > pa + B &&
                    (H[l].textBlock.y = pa + B - H[l].height),
                  H[l].textBlock.y < ua - B && (H[l].textBlock.y = ua - B))
                : (H[l].textBlock.y < pa - B && (H[l].textBlock.y = pa - B),
                  H[l].textBlock.y + H[l].height > ua + B &&
                    (H[l].textBlock.y = ua + B - H[l].height));
      }
      function f() {
        var a, b, c, d;
          ...
          for (var e = 0; e < R.length; e++)
            0 == H[e].textBlock.text.length
              ...
              : ((a = R[e]),
                ...
                u.reversed
                  ? (H[e].textBlock.y + H[e].height > pa + B &&
                      (H[e].textBlock.y = pa + B - H[e].height),
                    H[e].textBlock.y < ua - B && (H[e].textBlock.y = ua - B))
                  : (H[e].textBlock.y < pa - B && (H[e].textBlock.y = pa - B),
                    H[e].textBlock.y + H[e].height > ua + B &&
                      (H[e].textBlock.y = ua + B - H[e].height)));
        else
      ...
      function l() {
        ...
        for (var d, e, f, g, l, k, n = 1, r = 0; r < 2 * n; r++) {
          for (
            ...
            (f = H[m]),
            (g = f.textBlock),
            (k = (l = q(m) < R.length ? H[q(m)] : null) ? l.textBlock : null),
      ...
      function h(a, b) {
        return (
          (b < R.length ? H[b].textBlock.y : u.reversed ? pa + B : ua + B) -
          (0 > a
            ? u.reversed
              ? ua - B
              : pa - B
      ...
      function m(a, b, c) {
        ...
        if (0 === Z.length) l = ja;
          ...
          for (var s = 0; s < R.length; s++) {
            ...
            l.push(ja[s] + d);
            if (0 <= Z.indexOf(s) || (s < R.length && 0 <= Z.indexOf(s + 1)))
              d += e;
          }
        }
        g = (function () {
      ...
      if (!(0 >= a.dataSeriesIndexes.length)) {
        for (
          var u = this.data[a.dataSeriesIndexes[0]],
            ...
            z = 0,
            E = x.height - 2 * B,
            A = Math.min(x.width - 2 * D, 2.8 * x.height),
            F = !1,
            S = 0;
          S < y.length;
          S++
          ...
          if (
            ...
            !F &&
              ...
              (F = !0),
            (!F && "function" === typeof u.indexLabelFormatter) ||
        ...
        ("inside" !== u.indexLabelPlacement && F) ||
          (D = (x.width - 0.75 * A) / 2);
        var S = x.x1 + D,
          J = x.x2 - D,
          K = x.y1 + B,
        ...
        if (0 != u.length && u.dataPoints && u.visible && 0 !== y.length) {
          ...
          var X = (30 * (J - a)) / 100;
          "funnel" === u.type
            ? ((O = r(u.options.neckHeight) ? 0.35 * E : u.neckHeight),
          ...
          if (-1 !== S) {
            if (u.reversed)
              for (A.push(W), G = S.length - 1; 0 < G; G--)
                (W += S[G]), A.push(W);
            else for (G = 0; G < S.length; G++) (W += S[G]), A.push(W);
            if (u.reversed)
              for (G = 0; G < S.length; G++)
                A[G] < Y
                  ? (a.push(M), D.push(ba), (da = G))
                  : (a.push((A[G] - pa + ca * V) / ca),
                    D.push((A[G] - pa + ga * $) / ga));
            else
              for (G = 0; G < S.length; G++)
                A[G] < Y
            ...
            if (
              ...
              for (G = 0; G < R.length; G++)
                (R[G].x1 += z),
                  ...
                  (R[G].x3 += z),
                  (R[G].x4 += z),
                  R[G].x5 && ((R[G].x5 += z), (R[G].x6 += z)),
                  (H[G].textBlock.x += z);
            }
            for (G = 0; G < R.length; G++)
              (z = R[G]), ta(P, z, u.fillOpacity), ja.push(z.y1);
            w(P);
            F &&
              u.visible &&
              ("inside" === u.indexLabelPlacement || L.animationEnabled || n(P),
              L.animationEnabled || t());
            if (!F)
              for (G = 0; G < y.length; G++)
                (z = u.dataPointIds[G]),
                  (a = {
            ...
            !L.animationEnabled && S
              ? m(L, -1, 0)
              : L.animationEnabled && !L.animatedRender && m(L, -1, 0);
            ...
            var q = (p.legendMarkerType = p.legendMarkerType
                ...
                ? "error" === p.type && p._linkedSeries
                  ? p._linkedSeries.legendMarkerType
                    ? p._linkedSeries.legendMarkerType
                    : X.getDefaultLegendMarker(p._linkedSeries.type)
                  : X.getDefaultLegendMarker(p.type)
                : p.markerType),
              g = p.legendText
                ? p.legendText
      ...
      for (var h = 0, r = 0; r < l.length; r++) {
        for (var k = l[r], n = 0, p = 0; p < k.items.length; p++) {
          ...
          this.ghostCtx.fillRect(
            ...
            q.textBlock.x + q.textBlock.width - v,
            q.textBlock.height
          );
          ...
          if (q) {
            switch (this.type) {
              ...
              case "doughnut":
                ...
                m < q.radius &&
                  m > w &&
                  ((m = Math.atan2(d - v.y, a - v.x)),
                  0 > m && (m += 2 * Math.PI),
                  (m = Number(
                    ((((180 * (m / Math.PI)) % 360) + 360) % 360).toFixed(12)
                  )),
                  (v = Number(
                    (
              ...
              case "pyramid":
                ...
                d > m.y1 &&
                  ...
                  (m.y6
                    ? d > m.y6
                      ? ((f =
                          m.x6 + ((m.x5 - m.x6) / (m.y5 - m.y6)) * (d - m.y6)),
                        (m =
                          m.x3 + ((m.x4 - m.x3) / (m.y4 - m.y3)) * (d - m.y3)))
                      : ((f =
                          m.x1 + ((m.x6 - m.x1) / (m.y6 - m.y1)) * (d - m.y1)),
                        (m =
                          m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (d - m.y2)))
                    : ((f =
                        m.x1 + ((m.x4 - m.x1) / (m.y4 - m.y1)) * (d - m.y1)),
                      (m =
                        m.x2 + ((m.x3 - m.x2) / (m.y3 - m.y2)) * (d - m.y2))),
                  a > f &&
                    a < m &&
        ...
        if ("outside" === f.labelPlacement) {
          ...
          if ("bottom" === this._position || "top" === this._position)
            ...
            !r(this.sessionVariables.stripLineLabelMaxHeight)
              ...
              : (this.sessionVariables.stripLineLabelMaxHeight = E =
                  f.labelWrap
                    ? (0.8 * this.chart.height) >> 0
                    : 1.5 * this.labelFontSize);
          ...
          (l =
            ...
            r(f.labelBackgroundColor) &&
              (r(f.startValue) && 0 !== f.startValue
                ? (f.labelBackgroundColor = v ? "transparent" : null)
    ...
    E.setLayout = function (a, d, c, b, e, f) {
      ...
      for (g = 0; g < q.length; g++)
        if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
          for (
            var t = q[g].scaleBreaks._appliedBreaks, v = 0;
            v < t.length && !(t[v].startValue > q[g].viewportMaximum);
            v++
          )
            t[v].endValue < q[g].viewportMinimum ||
              (r(q[g].scaleBreaks.firstBreakIndex) &&
                (q[g].scaleBreaks.firstBreakIndex = v),
              t[v].startValue >= q[g].viewPortMinimum &&
      ...
      if ("normal" === e) {
          ...
          if (d && 0 < d.length)
            for (x = [], g = Y = 0; g < d.length; g++)
              d[g] && (d[g].lineCoordinates = {}),
                ...
                (Y += x[g]),
                (V += d[g] && !n.isNavigator ? d[g].margin : 0);
          else
                ...
                !a[g] ||
                  ...
                  0 < h
                    ...
                    : a[g].viewportMaximum === a[g].maximum &&
                      ...
                      (0 < A && (l += A), 0 < h && (m -= h))),
                n.panEnabled
                  ? (W = r(n.sessionVariables.axisX.height)
                      ? (n.sessionVariables.axisX.height = W)
                      : n.sessionVariables.axisX.height)
                  : (n.sessionVariables.axisX.height = W),
                (h = Math.round(f.y2 - W - e + G)),
                (k = Math.round(f.y2)),
                ...
                d[g]._labels &&
                  ...
                  (u =
                    ...
                    (h.textBlock.height - h.textBlock.fontSize / 2) *
                      Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle)))),
                n.panEnabled
                  ? (Y = r(n.sessionVariables.axisX2.height)
                      ? (n.sessionVariables.axisX2.height = Y)
                      : n.sessionVariables.axisX2.height)
                  : (n.sessionVariables.axisX2.height = Y),
                (h = Math.round(f.y1)),
                (k = Math.round(f.y2 + d[g].margin)),
                (d[g].lineCoordinates.y1 = h + Y + V - Q),
              ...
              b[g] &&
                ...
                (M =
                  b[g]._labels && 0 < b[g]._labels.length
                    ...
                    : 0),
                (h = Math.round(
                  f.y1 + Y + V < Math.max(M, p) ? Math.max(M, p) : f.y1 + Y + V
                )),
                (M =
                  0 < a.length
                    ? 0
        ...
        for (N = []; 4 > v; ) {
          ...
          if (a && 0 < a.length)
            ...
            A.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
          K.push(A);
          if (d && 0 < d.length)
            for (w = [], g = W = 0; g < d.length; g++)
              w.push(
          ...
          if (c && 0 < c.length)
            for (g = 0; g < c.length; g++)
              (c[g].lineCoordinates = {}),
                ...
                (m = Math.round(
                  f.x2 - W - V > n.width - 10 ? n.width - 10 : f.x2 - W - V
                )),
                c[g].labelAutoFit &&
                  !r(y) &&
                  (0 < !a.length &&
          ...
          if (n.panEnabled)
            for (g = 0; g < c.length; g++)
              p[g] = r(n.sessionVariables.axisY.height)
                ...
                c && 0 < c.length
                  ? Math.round(
                      c[0]
                        ...
                        : f.y2 - U > n.height - Math.max(M, 10)
                        ? n.height - Math.max(M, 10)
                        : f.y2 - U
                    )
                  : f.y2 > n.height - Math.max(M, 10)
                  ? n.height - Math.max(M, 10)
                  : f.y2;
              if (c && 0 < c.length)
            ...
            for (g = 0; g < d.length; g++) {
              ...
              if (b && 0 < b.length)
                for (M = 0; M < b.length; M++)
                  b[M] &&
                    b[M].labelAutoFit &&
                    ((m = b[M].lineCoordinates.x2), (l = m - W));
              d[g].lineCoordinates = {
                x1: m + P,
                y1: h,
                x2: m + P,
    ...
    E.render = function (a, d, c, b, e) {
      ...
      if (d && 0 < d.length)
        for (l = 0; l < d.length; l++)
          d[l].renderGrid(),
            v && (d[l].createMask(), d[l].renderBreaksBackground());
      if (c && 0 < c.length)
        for (l = 0; l < c.length; l++)
          c[l].renderGrid(),
            v && (c[l].createMask(), c[l].renderBreaksBackground());
      if (b && 0 < b.length)
        for (l = 0; l < b.length; l++)
          b[l].renderGrid(),
            v && (b[l].createMask(), b[l].renderBreaksBackground());
      if (a && 0 < a.length)
            ...
            (b / 1 <= a
              ...
              : ((this.interval =
                  b / (1 * K.yearDuration) <= a
                    ...
                    ? 4
                    : Math.floor(
                        E.getNiceNumber(b / (a - 1), !0) / K.yearDuration
                      )),
    ...
    ca.prototype.render = function (a, d, c) {
      ...
      if (this.snapToDataPoint) {
        ...
        if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
          ...
          for (var A = 0; A < this.parent.dataSeries.length; A++)
            (w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) &&
              0 <= w.index &&
              ((w.dataSeries = this.parent.dataSeries[A]),
          ...
          if (
            ...
            for (
              var w = Math.abs(
                  a - this.parent.convertValueToPixel(n[A].dataPoint.y[0])
                ),
                u = 0,
                t = 0;
              t < n.length;
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                for (var y = 0; y < n[t].dataPoint.y.length; y++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])
                  )),
                    u < w && ((w = u), (A = t));
              else
                (u = Math.abs(
                  a - this.parent.convertValueToPixel(n[t].dataPoint.y)
                )),
                  u < w && ((w = u), (A = t));
            ...
            for (
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                for (y = 0; y < n[t].dataPoint.y.length; y++)
                  (u = Math.abs(
                    a - this.parent.convertValueToPixel(n[t].dataPoint.y[y])
                  )),
                    u < w && ((w = u), (A = t));
            ...
            for (
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                ...
                (x += n[t].dataPoint.y),
                  (B = n[t].dataPoint.x.getTime
                    ? n[t].dataPoint.x.getTime()
                    : n[t].dataPoint.x),
                  (B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B])),
                  (u = Math.abs(a - this.parent.convertValueToPixel(B))),
                  u < w && ((w = u), (A = t));
          else
            for (
              w = Math.abs(
          ...
          if (
            ...
            b = 0;
            if (
              "rangeBar" === this.parent.dataSeries[A].type ||
              "error" === this.parent.dataSeries[A].type
            ) {
              w = Math.abs(
            ...
            if (this.parent.labels)
              for (
                n = Math.ceil(this.parent.interval), t = 0;
              ...
              if ("axisX" === this.parent.type)
                for (
                  t = this.parent.convertPixelToValue({ y: d }),
                    w = null,
                    A = 0;
                  A < this.parent.dataSeries.length;
                  A++
                )
                  (w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) &&
                    0 <= w.index &&
          ...
          for (A = 0; A < this.parent.dataSeries.length; A++)
            (w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) &&
              0 <= w.index &&
              ((w.dataSeries = this.parent.dataSeries[A]),
              null !== w.dataPoint.y && w.dataSeries.visible && n.push(w));
          ...
          if (B) {
            if ("axisX" === this.parent.type)
              for (
                t = this.parent.convertPixelToValue({ x: a }), w = null, A = 0;
                A < this.parent.dataSeries.length;
                A++
              )
                (w = this.parent.dataSeries[A].getDataPointAtX(t, !0)) &&
          ...
          if (
            ...
            for (
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                for (y = 0; y < n[t].dataPoint.y.length; y++)
                  (u = Math.abs(
                    d - this.parent.convertValueToPixel(n[t].dataPoint.y[y])
                  )),
                    u < w && ((w = u), (A = t));
              else
                (u = Math.abs(
                  d - this.parent.convertValueToPixel(n[t].dataPoint.y)
                )),
                  u < w && ((w = u), (A = t));
          else if (
              ...
              if (n[t].dataPoint.y && n[t].dataPoint.y.length)
                ...
                (x += n[t].dataPoint.y),
                  (B = n[t].dataPoint.x.getTime
                    ...
                    : n[t].dataPoint.x),
                  (B = 100 * (x / n[t].dataSeries.plotUnit.dataPointYSums[B])),
                  (u = Math.abs(d - this.parent.convertValueToPixel(B))),
                  u < w && ((w = u), (A = t));
          else
            for (
              w = Math.abs(
          ...
          b = 0;
          if (
            "rangeColumn" === this.parent.dataSeries[A].type ||
            "rangeArea" === this.parent.dataSeries[A].type ||
            "error" === this.parent.dataSeries[A].type ||
            "rangeSplineArea" === this.parent.dataSeries[A].type ||
            "candlestick" === this.parent.dataSeries[A].type ||
            "ohlc" === this.parent.dataSeries[A].type ||
            "boxAndWhisker" === this.parent.dataSeries[A].type
          ) {
            w = Math.abs(d - this.parent.convertValueToPixel(y.dataPoint.y[0]));
            for (t = u = 0; t < y.dataPoint.y.length; t++)
              (u = Math.abs(
            ...
            "stackedColumn" === this.parent.dataSeries[A].type ||
            "stackedArea" === this.parent.dataSeries[A].type
          ) {
            ...
            "stackedColumn100" === this.parent.dataSeries[A].type ||
            "stackedArea100" === this.parent.dataSeries[A].type
          ) {
            w = Math.abs(d - this.parent.convertValueToPixel(n[0].dataPoint.y));
            x = u = 0;
            for (t = A; 0 <= t; t--)
            ...
            "waterfall" === this.parent.dataSeries[A].type
              ? ((v =
                  1 === q.lineWidth % 2
        ...
        if (
          ...
          if (this.chart.axisX)
            for (var w = 0; w < this.chart.axisX.length; w++) {
              for (
                var h =
                    "xySwapped" === this.chart.plotInfo.axisPlacement
                      ? this.chart.axisX[w].convertPixelToValue({ y: d })
                      : this.chart.axisX[w].convertPixelToValue({ x: a }),
                  k = null,
                  b = 0;
                b < this.chart.axisX[w].dataSeries.length;
                b++
              )
                (k = this.chart.axisX[w].dataSeries[b].getDataPointAtX(h, c)) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX[w].dataSeries[b]),
          ...
          if (this.chart.axisX2)
            for (w = 0; w < this.chart.axisX2.length; w++) {
              h =
                "xySwapped" === this.chart.plotInfo.axisPlacement
                  ? this.chart.axisX2[w].convertPixelToValue({ y: d })
                  : this.chart.axisX2[w].convertPixelToValue({ x: a });
              k = null;
              for (b = 0; b < this.chart.axisX2[w].dataSeries.length; b++)
                (k = this.chart.axisX2[w].dataSeries[b].getDataPointAtX(
                  h,
                  c
                )) &&
                  0 <= k.index &&
                  ((k.dataSeries = this.chart.axisX2[w].dataSeries[b]),
                  null !== k.dataPoint.y && k.dataSeries.visible && m.push(k));
              k = null;
            }
